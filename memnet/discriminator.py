...
def define_patch_net():
    ...
    net['conv_1'] = Conv2DLayer(net['patch'], num_filters=64, filter_size=(4, 4), stride = (2, 2),
                                   nonlinearity=leaky_relu)
    print(lasagne.layers.get_output_shape(net['conv_1']))
    net['conv_2'] = Conv2DLayer(net['conv_1'], num_filters=128, filter_size=(4, 4), stride=(2, 2),
                                                 nonlinearity=leaky_relu)
    print(lasagne.layers.get_output_shape(net['conv_2']))
    ...
    net['out'] = ll.DenseLayer(net['conv_4'], num_units=1, nonlinearity=lasagne.nonlinearities.sigmoid)
